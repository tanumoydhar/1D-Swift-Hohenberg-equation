...
Lx = 64*pi; #length of spatial domain along x-direction
nsave = 10;
Nt = 5000;
...
N_fm = 512; #no. of fourier modes
dt = 0.02;  #default time step

x = (1.0*Lx/N_fm)*arange(0, N_fm);
u = cos(x)# initial condition

kx = zeros(N_fm);
kx[0:N_fm/2] = arange(0,N_fm/2); kx[N_fm/2+1:] = arange(-N_fm/2+1,0,1);
